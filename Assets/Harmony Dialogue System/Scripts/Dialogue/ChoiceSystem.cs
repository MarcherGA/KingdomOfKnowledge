...
namespace HarmonyDialogueSystem
{
    public class ChoiceSystem : MonoBehaviour
    {
        ...
        public void SetChoiceSystem(GameObject choicePrefab, LayoutGroup choiceContainer)
        {
        ...
        public void MakeChoice(int choiceIndex, Story currentStory)
        {
            ...
            DialogueManager.instance.ContinueStoryAfterChoice();
        }
#endif
