...
namespace HarmonyDialogueSystem
{
    ...
    public class DialogueManager : MonoBehaviour
    {
        ...
        [Tooltip("The Image of the Continue Button")]
        ...
        [SerializeField] LayoutGroup choicesContainer;
        ...
        [Tooltip("The time interval between each letter")]
        ...
        public UnityEvent dialogueSystemOnEvent;

        [Tooltip("Event for when dialogue is ending")]
        public UnityEvent dialogueSystemOffEvent;
        ...
        public void ButtonDownContinueStory()
        {
            ...
            if (currentStoryObject.CanManuallyContinue() && _canContinueToNextLine) ContinueStory();
        }
        ...
        public void EnterDialogueMode(TextAsset file, FileTypeUsed fileTypeUsed)
        {
            ...
            InputManagerDialogue.instance.onContinue += ButtonDownContinueStory;
        ...
        public void ContinueStoryAfterChoice()
        {
            if (currentStoryObject == null) throw new Exception("No StoryObject found. EnterDialogueMode function has probably been bypassed or there is an error that doesn't allow it to be created");
            if (currentStoryObject.CanContinue())
            {
                currentStoryObject.NextLine();
        ...
        public void ContinueStory()
        {
            ...
            if (currentStoryObject.CanContinue())
            {
                string line = currentStoryObject.NextLine();
        ...
        private IEnumerator DisplayLine(string line) 
    {
        ...
        ChoiceSystem.Instance.DisableChoices();
        ...
        InputManagerDialogue.instance.onContinue -= ButtonDownContinueStory;
        InputManagerDialogue.instance.onContinue += SetSkipType;
        ...
        private void SetSkipType(bool shouldSkip)
        {
            _skipTyping = shouldSkip;
        }

        private void SetSkipType()
        {
            SetSkipType(true);
        }
    }
